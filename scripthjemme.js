        ...
        function addEventListenersToButtons() {
            document.querySelector("#button8").addEventListener("click", toggleMenu8);
            document.querySelector("#button7").addEventListener("click", toggleMenu7);
            document.querySelector("#button6").addEventListener("click", toggleMenu6);
            document.querySelector("#button5").addEventListener("click", toggleMenu5);
            document.querySelector("#button4").addEventListener("click", toggleMenu4);
            document.querySelector("#button3").addEventListener("click", toggleMenu3);
            document.querySelector("#button2").addEventListener("click", toggleMenu2);
